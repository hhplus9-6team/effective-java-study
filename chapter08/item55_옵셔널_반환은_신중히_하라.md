...
│   • 진짜 예외 상황 아닌데         • 나중에 엉뚱한 곳에서          │
│     예외 쓰는 건 부적절           • NullPointerException 터짐    │
│                                                                 │
└─────────────────────────────────────────────────────────────────┘
```
...
│                                                                │
│  Optional.of(value)        → 값이 든 옵셔널                    │
│                              (value가 null이면 NPE 발생!)      │
│                                                                │
│  Optional.ofNullable(value)→ value가 null이면 빈 옵셔널,       │
│                              아니면 값이 든 옵셔널              │
│                                                                │
└────────────────────────────────────────────────────────────────┘
```
...
├────────────────────────────────────────────────────────────────┤
│                                                                │
│  1. 컬렉션/배열/스트림을 감싸지 말 것                           │
│     Optional<List<T>> → 그냥 빈 List<T> 반환                   │
│                                                                │
│  2. Map의 값으로 쓰지 말 것                                     │
│     Map<K, Optional<V>> → "키 없음" vs "빈 Optional" 혼란      │
│                                                                │
│  3. 컬렉션의 원소로 쓰지 말 것                                  │
│     List<Optional<T>> → 복잡성만 증가                          │
│                                                                │
│  4. 박싱된 기본 타입 담지 말 것                                 │
│     Optional<Integer> → OptionalInt 사용                       │
│                                                                │
└────────────────────────────────────────────────────────────────┘
```
...
┌────────────────────────────────────────────────────────────┐
│                                                            │
│  Optional은 "선물 상자"라고 생각하면 됨                    │
│                                                            │
│  ┌──────┐                                                  │
│  │ 📦  │ ← 상자 안에 선물이 있을 수도, 없을 수도          │
│  └──────┘                                                  │
│                                                            │
